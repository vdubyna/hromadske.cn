...
echo "jQuery(function($) {
	$(document).ready(function(){
		...
		$(document).on('click', '#map_button_visual', function(){
			tb_show('" . $text_add . "', '" . $admin_url . "admin-ajax.php?action=get_mm_list&mode=html&TB_iframe');
				return false;
		});
		$('#wp-content-media-buttons').append('<a style=\'margin-left:5px;\' class=\'button\' title=\'" . $text_add . "\' id=\'map_button_visual\' href=\'#\'><div style=\'float:left;\'><img src=\'" . $leaflet_plugin_url . "inc/img/icon-tinymce.png#\' style=\'padding:0 5px 3px 0;\'></div><div style=\'float:right;padding-top:0px;\'>" . $text_add . "</div></a>');
	});
});";
?>